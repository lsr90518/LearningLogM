                            ...
                            <div id="Center">
                                ...
                                <div class="dparts searchResultList">
                                	<div class="parts">
                                        ...
                                        <div class="block">
                                        			<a href="${ctx}/admin/language/${language.id}">Edit</a>
                                        			&nbsp;<a href="${ctx}/admin/language">Return</a>
		                                    <form:form commandName="language" action="${ctx}/admin/${user.id}/edit" method="post">
			                                    <table>
			                                        <tr>
