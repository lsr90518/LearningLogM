                                ...
                                <div class="dparts searchResultList">
                                        ...
                                        <div class="block">
                                        	<ul>
                                        		...
                                        		<li>
                                        			<a href="${ctx}/admin">Return</a><br />
                                        			<a href="${ctx}/admin/user/add">Add new user</a>
                                        		</li>
                                        		<li>
                                        			<br />
                                        			<form action="${ctx}/admin/user" method="get">
                                        		...
                                        		<li>
                                        			<table>
                                        				...
                                        				<tbody>
                                        					...
                                        					<tr>
                                        						<td><a href="${ctx}/item/${item.item_id}">${item.item_id}</a></td>
                                        						<td>${item.file_id}</td>
