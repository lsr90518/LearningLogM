                    ...
                    <div id="ContentsContainer">
                        ...
                        <div id="LayoutA" class="Layout">
                            ...
                            <div id="Center" style="text-align:center; margin: 25px 0px; border: 1px dotted #FF8F00;border-radius: 10px;padding:10px;">
                                ...
                                alt="Get it on Google Play" src="${systemUrl}/images/get_it_on_play_logo.png" /></a><br />
                            	<%--
                            	<p style="font-weight: bold">Learning Log Navigator</p>
                                <c:set var="naviApkUrl" value="http://chart.apis.google.com/chart?cht=qr&chs=320x320&chl=${urlApkNavigator}"></c:set>
                            	<img alt="" src="${naviApkUrl}" /><br />
                            	 --%>
                            </div><!-- Center -->
                        </div><!-- Layout -->
                        <div id="sideBanner">
