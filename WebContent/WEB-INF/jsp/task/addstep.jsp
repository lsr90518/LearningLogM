                    ...
                    <div id="ContentsContainer">
                     <div id="LayoutTask" class="Layout">
                            ...
                            <div id="Center">
                                <div id="diaryForm" class="dparts form">
									...
									<div class="navbar-inverse">
                                        ...
                                        <h3 style="font-size: 17px; font-weight: bolder; line-height: 150%">Step of task script</h3></div></div>
                                        ...
                                        <form:form commandName="script" action="${taskUrl}" method="post" enctype="multipart/form-data">
                                            <table>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td> 
	                                                   <form:input path="image_name"  cssStyle="width:90%" />&nbsp;
                                                </tr>
                                         ...
                                         <c:url value="/task/${task.id}/publish" var="taskUrl" />
                                        <form:form commandName="script" action="${taskUrl}" method="post" enctype="multipart/form-data">
                                        <div class="operation">
                                                <ul class="moreInfo button">
                                                     <li>   
                        ...
                        <div id="sideBanner">
                           <div class="navbar navbar-inner" style="position: static;">
									<div class="navbar-inverse">
                                    <h3 style="font-size: 13px; font-weight: bolder; line-height: 150%">Related Learning Logs</h3>
                           </div></div>
                            <div>
