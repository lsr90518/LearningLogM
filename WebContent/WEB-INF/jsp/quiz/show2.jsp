                                                	...
                                                	<c:choose>
                                                        <c:when test= "${!answered}">
                                                            ...
                                                            <c:if test="${quiz.quiztypeid == 2}">
                                                            	 <img alt="" src="<tags:static filename="${choice.content}_160x120.png" />" />
                                                            </c:if>
                                                            <c:if test="${quiz.quiztypeid != 2}">
                                                        ...
                                                        <c:otherwise>
                                                        	<c:choose>
                                                              ...
                                                              <c:url value="/item/${choice.item_id}" var="itemurl" />
                                                               <c:if test="${quiz.quiztypeid == 2}">
                                                               	 <a href="${itemurl}" target="_blank"><img alt="" src="<tags:static filename="${choice.content}_160x120.png" />" /></a> 
                                                               </c:if>
                                                               <c:if test="${quiz.quiztypeid != 2}">
