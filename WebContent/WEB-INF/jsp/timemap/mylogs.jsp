...
<html>
    ...
    <c:param name="content">
        ...
        <script src="${ctx}/js/timemap/lib/mxn/mxn.js?(googlev3)"></script>
        <script src="${ctx}/js/timemap/lib/timeline-1.2.js"></script>
        <script src="${ctx}/js/timemap/timemap_full.pack.js"></script>
        <style>
        div, p {
        ...
        <script>
            ...
            $(function(){
                tm = TimeMap.init({
                    ...
                    options: {
                        eventIconPath: "${ctx}/js/timemap/images/"
                    }, 
                    datasets: [
                        {
                            id: "llog",
                            ...
                            type: "json_string",
                            options: {
                                url: "${ctx}/timemap/mylogs?format=json"
                            }
                        }
                    ],
                    bandIntervals:[
