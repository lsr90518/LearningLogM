...
public class UserMessageController {
	...
	public String send(String umsg_sendto, String content){
		...
		Users sendToUser = userService.findById(sendTo);
		if(sendToUser == null){
	...
	public String checkMessage(){
		Users sendFromUser = SecurityUserHolder.getCurrentUser();
		return String.valueOf(userMessageService.checkMessage(sendFromUser.getId()));
	}
	...
	public String readMessage(String msgId){
		...
		data.put("sendFromId", msg.getSendFrom());
		Users user = userService.findById(msg.getSendFrom());
		data.put("sendFromName", user.getNickname());
